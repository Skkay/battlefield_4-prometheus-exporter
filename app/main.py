...
vehicleStats_rawr_timePlayed = Gauge('battlefield_4_vehicleStats_rawr_timePlayer', 'Time played with RAWR in seconds')
...
vehicleStats_ucav_timePlayed = Gauge('battlefield_4_vehicleStats_ucav1_timePlayer', 'Time played with UCAV in seconds')
...
vehicleStats_mav_timePlayed = Gauge('battlefield_4_vehicleStats_mav_timePlayer', 'Time played with MAV in seconds')
...
vehicleStats_suav_timePlayed = Gauge('battlefield_4_vehicleStats_suav_timePlayer', 'Time played with SUAV in seconds')
vehicleStats_xd1accipiter_kills = Gauge('battlefield_4_vehicleStats_xd1accipiter_kills', 'Number of kills with XD-1 ACCIPITER')
vehicleStats_xd1accipiter_timePlayed = Gauge('battlefield_4_vehicleStats_xd1accipiter_timePlayer', 'Time played with XD-1 ACCIPITER in seconds')
...
vehicleStats_m224mortar_timePlayed = Gauge('battlefield_4_vehicleStats_m224mortar_timePlayer', 'Time played with M224 MORTAR in seconds')
...
vehicleStats_eodbot_timePlayed = Gauge('battlefield_4_vehicleStats_eodbot_timePlayer', 'Time played with EOD BOT in seconds')
...
vehicleStats_aamine_timePlayed = Gauge('battlefield_4_vehicleStats_aamine_timePlayer', 'Time played with AA MINE in seconds')
...
def refresh_vehicleStats_metrics():
    ...
    vehicleStats_rawr_timePlayed.set(data['rawr']['timeIn'])
    ...
    vehicleStats_ucav_timePlayed.set(data['ucav1']['timeIn'])
    ...
    vehicleStats_mav_timePlayed.set(data['mav']['timeIn'])
    ...
    vehicleStats_suav_timePlayed.set(data['suav']['timeIn'])
    vehicleStats_xd1accipiter_kills.set(data['xd-1-accipiter']['kills'])
    vehicleStats_xd1accipiter_timePlayed.set(data['xd-1-accipiter']['timeIn'])
    ...
    vehicleStats_m224mortar_timePlayed.set(data['m224-mortar1']['timeIn'])
    ...
    vehicleStats_eodbot_timePlayed.set(data['eod-bot1']['timeIn'])
    ...
    vehicleStats_aamine_timePlayed.set(data['aa-mine1']['timeIn'])
